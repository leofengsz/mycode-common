...
public class PositionRenderListener implements RenderListener{
	...
	private Map<String, TemplateLabel> result = new HashMap<String, TemplateLabel>();
	@Override
	public void renderText(TextRenderInfo textInfo) {
		...
		for (String keyWord : findText) {
			if (null != text && text.equals(keyWord)){
				...
				TemplateLabel region = new TemplateLabel(keyWord);
	...
	public Map<String, TemplateLabel> getResult() {
